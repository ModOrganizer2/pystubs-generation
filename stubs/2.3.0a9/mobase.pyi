...
class IFileTree(FileTreeEntry):
    ...
    def __repr__(self) -> str: pass
    def addDirectory(self, arg1: str) -> "IFileTree": pass
    def addFile(self, arg1: str) -> "FileTreeEntry": pass
    ...
    def merge(self, arg1: "IFileTree", arg2: bool = False) -> Union[Dict["FileTreeEntry", "FileTreeEntry"], int]: pass
    ...
    def walk(self, arg1: Callable[[str, "FileTreeEntry"], "IFileTree.WalkReturn"], arg2: str = '\\'): pass
...
class IPluginGame(IPlugin):
    ...
    def feature(self, arg1: "object") -> "object": pass
...
class ModDataChecker:
    def __init__(self): pass
    def dataLooksValid(self, arg1: "IFileTree") -> bool: pass
