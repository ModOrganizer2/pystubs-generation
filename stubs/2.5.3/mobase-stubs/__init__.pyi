...
class IDownloadManager:
    ...
    def startDownloadNexusFileForGame(
        self: IDownloadManager, game_name: str, mod_id: int, file_id: int
    ) -> int:
        """
        Download a file from www.nexusmods.com.
...
class IExecutable:
    def arguments(self: IExecutable) -> str:
        """
        ...
        """
        ...
    def binaryInfo(self: IExecutable) -> PyQt6.QtCore.QFileInfo:
        """
        Returns:
            The file info of the executable binary.
        """
        ...
    def hide(self: IExecutable) -> bool:
        """
        Returns:
            True if this executable is hidden in the user interface.
        """
        ...
    def isShownOnToolbar(self: IExecutable) -> bool:
        """
        Returns:
            True if the executable is shown on the toolbar.
        """
        ...
    def minimizeToSystemTray(self: IExecutable) -> bool:
        """
        Check if Mod Organizer should minimize to the system tray while this executable
        is running.

        Returns:
            True if Mod Organizer should minimize to the system tray while this executable is running.
        """
        ...
    def steamAppID(self: IExecutable) -> str:
        """
        Returns:
            The Steam App ID associated with this executable, or an empty string if there is none.
        """
        ...
    def title(self: IExecutable) -> str:
        """
        Returns:
            The title of the executable.
        """
        ...
    def usesOwnIcon(self: IExecutable) -> bool:
        """
        Returns:
            True if the executable's application icon is used for desktop shortcuts.
        """
        ...
    def workingDirectory(self: IExecutable) -> str:
        """
        Returns:
...
class IExecutablesList:
    """
    Interface to the list of executables configured in Mod Organizer.
    """

    def contains(self: IExecutablesList, title: str) -> bool:
        """
        Check if an executable with the specified title exists.

        Args:
            title: Title of the executable to check.

        Returns:
            True if an executable with the specified title exists, False otherwise.
        """
        ...
    def executables(self: IExecutablesList) -> object:
        """
        Retrieve all configured executables.

        Returns:
            A generator yielding all configured executables.
        """
        ...
    def getByBinary(
        self: IExecutablesList, info: PyQt6.QtCore.QFileInfo
    ) -> IExecutable:
        """
        Retrieve an executable by its binary file info.

        Args:
            info: File info of the executable binary to retrieve.

        Returns:
            The executable with the specified binary, or `None` if not found.
        """
        ...
    def getByTitle(self: IExecutablesList, title: str) -> IExecutable:
        """
        Retrieve an executable by its title.

        Args:
            title: Title of the executable to retrieve.

        Returns:
            The executable with the specified title, or `None` if not found.
        """
        ...
...
class IInstance:
    """
    Represents a Mod Organizer instance, either global or portable.
    """

    def displayName(self: IInstance) -> str:
        """
        Returns:
            The instance name; this is the directory name or "Portable" for portable instances.
        """
        ...
    def gameDirectory(self: IInstance) -> str:
        """
        Returns:
            The directory where the game is installed, or an empty string if the INI file could not be read.
        """
        ...
    def gameName(self: IInstance) -> str:
        """
        Returns:
            The name of the game managed by this instance, or an empty string if the INI file could not be read.
        """
        ...
    def isPortable(self: IInstance) -> bool:
        """
        Returns:
            True if this is a portable instance, False if it is a global one.
        """
        ...

class IInstanceManager:
    """
    Interface to the instance manager of Mod Organizer.
    """

    def currentInstance(self: IInstanceManager) -> IInstance:
        """
        Returns:
            The current instance.
        """
        ...
    def getGlobalInstance(self: IInstanceManager, instanceName: str) -> IInstance:
        """
        Retrieve the global instance corresponding to the given name.

        Args:
            instanceName: Name of the global instance to retrieve. This is the directory
                name of the instance.

        Returns:
            The global instance corresponding to the given name, or `None` if no such instance exists.
        """
        ...
    def globalInstancePaths(self: IInstanceManager) -> list[PyQt6.QtCore.QDir]:
        """
        ...
        Returns:
            The list of absolute paths to all global instances.
        """
        ...
...
class IModInterface:
    ...
    def addNexusCategory(self: IModInterface, category_id: int) -> None:
        ...
        """
        ...
    def author(self: IModInterface) -> str:
        """
        Returns:
            The author of this mode.
        """
        ...
    ...
    def trackedState(self: IModInterface) -> TrackedState:
        ...
        """
        ...
    def uploader(self: IModInterface) -> str:
        """
        Returns:
            The uploader of this mod.
        """
        ...
    def uploaderUrl(self: IModInterface) -> str:
        """
        Returns:
            The URL of the uploader of this mod.
        """
        ...
...
class IOrganizer:
    ...
    def downloadsPath(self: IOrganizer) -> str:
        ...
        """
        ...
    def executablesList(self: IOrganizer) -> IExecutablesList:
        """
        Returns:
            The interface to list of executables.
        """
        ...
    def findFileInfos(
        self: IOrganizer,
    ...
    def getPluginDataPath() -> str:
        ...
        """
        ...
    def getProfile(self: IOrganizer, name: str) -> IProfile:
        """
        ...
        Returns:
            The profile with the specified name or None if no such profile exists.
        """
        ...
    def installMod(
        self: IOrganizer,
        ...
        """
        ...
    def instanceManager(self: IOrganizer) -> IInstanceManager:
        """
        Returns:
            The interface to the instance manager.
        """
        ...
    def instanceName(self: IOrganizer) -> str:
        """
    ...
    def profileName(self: IOrganizer) -> str:
        ...
        """
        ...
    def profileNames(self: IOrganizer) -> Sequence[str]:
        """
        Returns:
            The names of all existing profiles.
        """
        ...
    ...
    def version(self: IOrganizer) -> Version:
        """
        Retrieve the running version of MO2.

        Returns:
            The running version of MO2.
        """
        ...
...
class IPluginList:
    ...
    def author(self: IPluginList, name: str) -> str:
        """
        ...
        Returns:
            The author of the plugin or an empty string if the plugin does not exist.
        """
        ...
    def description(self: IPluginList, name: str) -> str:
        """
        ...
        Returns:
            The description of the plugin or an empty string if the plugin does not exist.
        """
        ...
    def formVersion(self: IPluginList, name: str) -> int:
        """
        Retrieve the form version of the plugin.

        Args:
            name: Filename of the plugin (without path but with file extension).

        Returns:
            The form version of the plugin or -1 if the plugin does not exist.
        """
        ...
    ...
    def hasNoRecords(self: IPluginList, name: str) -> bool:
        ...
        """
        ...
    def headerVersion(self: IPluginList, name: str) -> float:
        """
        Retrieve the header version of the plugin.

        Args:
            name: Filename of the plugin (without path but with file extension).

        Returns:
            The header version of the plugin or -1 if the plugin does not exist.
        """
        ...
    def isBlueprintFlagged(self: IPluginList, name: str) -> bool:
        """
...
class ModRepositoryFileInfo:
    ...
    @uploader.setter
    def uploader(self, arg0: str) -> None: ...
    @property
    def uploaderUrl(self) -> str: ...
    @uploaderUrl.setter
    def uploaderUrl(self, arg0: str) -> None: ...
    @property
    def uri(self) -> str: ...
    @uri.setter
...
class Version:
    ...
    class FormatMode(Enum):
        """
        Enumeration defining how to format version into string.
        """
        ...
        def name(self) -> str: ...
        def __and__(
            self: Version.FormatMode, arg0: Version.FormatMode
        ) -> Version.FormatMode: ...
    ...
    class ParseMode(Enum):
        """
        Enumeration defining how to parse version from string.
        """
    ...
    class ReleaseType(Enum):
        """
        Enumeration representing the release type of a version.
        """
    ...
    def patch(self) -> int: ...
    @property
    def prereleases(self) -> list[int | ReleaseType]: ...
    @property
    ...
    def isPreRelease(self: Version) -> bool:
        ...
        Returns:
            True if this version is a pre-release version, False otherwise.
        """
        ...
    @staticmethod
    def parse(value: str, mode: Version.ParseMode = ParseMode.SEMVER) -> Version:
        ...
        """
        ...
    def string(self: Version, mode: Version.FormatMode = 0) -> str:
        """
        ...
        Returns:
            A string representing this version according to the given modes.
        """
        ...
...
class GamePlugins(GameFeature):
    ...
    @abc.abstractmethod
    def blueprintPluginsAreSupported(self: GamePlugins) -> bool:
        """
        Returns:
            True if blueprint plugins are supported, False otherwise.
        """
        ...
    @abc.abstractmethod
...
class IFileTree(FileTreeEntry):
    ...
    class GlobPatternType(Enum):
        ...
        @property
        def name(self) -> str: ...
        def __eq__(self: IFileTree.GlobPatternType, other: object) -> bool: ...
        def __int__(self: IFileTree.GlobPatternType) -> int: ...
        def __ne__(self: IFileTree.GlobPatternType, other: object) -> bool: ...
        def __str__(self: IFileTree.GlobPatternType) -> str: ...
    ...
    GLOB: GlobPatternType = ...
    MERGE: InsertPolicy = ...
    REGEX: GlobPatternType = ...
    ...
    def glob(
        self: IFileTree,
        pattern: str,
        type: IFileTree.GlobPatternType = GlobPatternType.GLOB,
    ) -> Iterator[FileTreeEntry]:
        """
        Glob entries matching the given pattern in this tree.
        ...
        Returns:
            An iterator over entry of this tree matching the given pattern.
        """
        ...
    def insert(
        self: IFileTree,
    ...
    def walk(
        ...
        ...
    @overload
    def walk(self: IFileTree) -> Iterator[FileTreeEntry]:
        """
        ...
        Returns:
            An iterator over entry of this tree.
        """
        ...
...
class IPluginGame(IPlugin):
    ...
    def binaryName(self: IPluginGame) -> str:
        ...
        ...
    @abc.abstractmethod
    def blueprintPrefix(self: IPluginGame) -> str:
        """
        Returns:
            The blueprint plugin prefix for blueprint auto loading.
        """
        ...
    @abc.abstractmethod
    ...
    def getLauncherName(self: IPluginGame) -> str:
        ...
        """
        ...
    def getModMappings(self: IPluginGame) -> Dict[str, Sequence[str]]:
        """
        Gets a virtualization mapping for mod directories.
        """
        ...
    @abc.abstractmethod
    ...
    def lootGameName(self: IPluginGame) -> str:
        ...
        """
        ...
    def modDataDirectory(self: IPluginGame) -> str: ...
    @abc.abstractmethod
...
class IPluginInstallerCustom(IPluginInstaller, IPlugin):
    """
...
class IPluginInstallerSimple(IPluginInstaller, IPlugin):
    """
